...
//class fixture_construction_exception : public logiqa::fixture
//{
//public:
...
//LOGIQA_TEST_FIXTURE(test_fixture_construction_exception, "exceptiontest", fixture_construction_exception) { ASSERT_FAIL }
